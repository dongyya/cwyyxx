		             	...
		             	<div class="checkbox control-wrapper">
							<div style="height:10px;"></div>
			          		<div style="margin-top: -27px;">
			          		   <a style="outline: none;width:50px" href="${pageContext.request.contextPath }/index/goFindpwd.html" class="text-right pull-right" target="_bank">注册</a> 
			          		   <a style="outline: none" href="${pageContext.request.contextPath }/index/goFindpwd.html" class="text-right pull-right" target="_bank">找回密码</a>
			          		</div>
		              	</div>
			        </div>
		        </div>
